...
public class TestAffirmationCollectionDeBase {
    ...
    public void onNePeutPasAffirmerQUneCollectionEstEgaleAUneCollectionDifférente() {
        ...
        Exception exception = capteur.capte(() -> new AffirmationCollectionDeBase<>(valeursTestées).sont(valeursAttendues));
    ...
    public void onNePeutPasAffirmerQuUneCollectionPossèdeUnNombreErronéDElements() {
        Exception exception = capteur.capte(() -> new AffirmationCollectionDeBase<>(Listes.cree("a", "b")).sontAuNombreDe(10));
    ...
    public void onNePeutPasAffirmerATortQuUneCollectionRespecteUneSpécification() {
        ...
        Exception exception = capteur.capte(() -> new AffirmationCollectionDeBase<>(Listes.cree(1, 2)).respectent(spécification));
