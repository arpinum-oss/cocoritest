 ...
 */
public interface AffirmationObjetAuFeminin<TObjet> {
	 ...
	 */
	ConjonctionObjetAuFeminin<TObjet> est(TObjet objetAttendu);
	 ...
	 * @throws fr.arpinum.cocoritest.interne.affirmation.ExceptionAffirmation si l'affirmation est erronée.
	 */
	ConjonctionObjetAuFeminin<TObjet> nEstPas(TObjet objetNonAttendu);
	 ...
	 * @throws fr.arpinum.cocoritest.interne.affirmation.ExceptionAffirmation si l'affirmation est erronée.
	 */
	ConjonctionObjetAuFeminin<TObjet> respecte(Specification<TObjet> spécification);
}
